...
class _ProblemService implements ProblemService {
  ...
  @override
  Future<HttpResponse<dynamic>> sendNotificationToEngineers(
    NotificationTopicRequestBody notificationTopicRequestBody,
    String bearerToken,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _data.addAll(notificationTopicRequestBody.toJson());
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/projects/safety-first-eb105/messages:send',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
